...
class LocalDataSourceInitializer {
  ...
  createTable(Database db) async {
    return db.execute(
        'CREATE TABLE `${SqfLiteConstants.requestsTable}` (${SqfLiteConstants.idColumn} TEXT NOT NULL, `${SqfLiteConstants.usernameColumn}` TEXT NOT NULL, `${SqfLiteConstants.serviceTypeColumn}` TEXT NOT NULL, `${SqfLiteConstants.requestDTColumn}` TEXT NOT NULL, `${SqfLiteConstants.serviceDTColumn}` TEXT NOT NULL, `${SqfLiteConstants.branchIdColumn}` TEXT NOT NULL )');
  }
